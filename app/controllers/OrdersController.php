...
//			$creditcard->save();								
		...
		//find the user's credit card in the CreditCards table and return it to the browser to let the user choose it
		$conditions = array('conditions'=>array('user_id' => $user['_id']));
    	$creditCards = CreditCard::find( 'all', $conditions );
								
		return compact('creditCards','address','addresses_ddwn','selected','cartEmpty','payment','shipping','shipDate','cartExpirationDate');
	}
