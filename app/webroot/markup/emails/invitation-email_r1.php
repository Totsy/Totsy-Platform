					...
					<table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-left:1px solid #666666; border-right:1px solid #666666">
						<tr>
							<td colspan="4" style="padding:0 10px 10px 10px">
								...
								<!-- img src="../../img/email/invitation-mainpic.jpg" alt="invitation-mainpic" width="570" height="177" / -->
							</td>
						</tr>
						<tr>
							<td style="padding:20px" valign="top">
								<p>Greetings</p> 
								<p>[Name of Person] thinks you should join Totsy and has invited you! Totsy is the premier private shopping network for moms on-the-go and moms-to-be.</p>
								...
								<p><a href="#" title="Click to Accept Invitation" " style="color:#E00000;text-decoration:none">Click here</a> to accept this invitation, and start experiencing exclusive access, top brands, and great deals today!</p>
								<p>All the best,</p>
