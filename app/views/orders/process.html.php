...
<div id="middle" class="fullwidth">
  ...
  <div id="page">
    ...
    <table>
      ...
      <td valign="top" style="vertical-align:top; padding-right:10px; width:303px;"><h1 style="color:#707070; font-size:22px;">Payment Information <span style="font-size:12px; font-weight:normal;"><span class="red">*</span> Required Fields</span></h1>
        <hr />
        <div>
          <fieldset>
      ...
      <td valign="top" style="vertical-align:top; width:300px;"><h1 style="color:#707070; font-size:22px;">Credits &amp; Promotional Codes</h1>
        <hr />
        <table class="order-status" width="100%">
          ...
          <tr>
            ...
            <td style="text-align:left; padding-left:10px;">$
              <?=number_format((float) $shippingCost, 2);?></td>
          </tr>
          <?php if ($overShippingCost !=0): ?>
          <tr>
            <td><strong>Oversize Shipping:</strong></td>
            <td style="text-align:left; padding-left:10px;">$
              <?=number_format((float) $overShippingCost, 2);?></td>
          </tr>
          <?php endif; ?>
          <tr>
            ...
            <div style="padding:10px; background:#eee;">
              ...
              You have $
              <?=number_format((float) $userDoc->total_credit, 2);?>
              in credits
              <hr />
        ...
        <td valign="top" style="vertical-align:top; padding-left:10px; width:220px"><?php if ($billingAddr) { ?>
    ...
    <table width="100%" class="cart-table">
      <thead>
        <tr >
          <td colspan="3" style="vertical-align:bottom; font-weight:bold; font-size:18px;"><?=$orderEvents[$key]['name']?>
          <td>
          <td></td>
      ...
      <tbody>
        ...
        <tr id="<?=$item['_id']?>" class="alt<?=$x?>" style="margin-top:10px;">
          ...
          <td class="cart-desc"><?=$this->form->hidden("item$x", array('value' => $item['_id'])); ?>
            <strong>
            <?=$this->html->link($item['description'], $itemUrl);
							?>
            </strong><br>
            <strong>Color:</strong>
            <?=$item['color'];?>
            ...
            <strong>Size:</strong>
            <?=$item['size'];?></td>
          <td class="<?="price-item-$x";?>"><strong style="color:#009900;">$
            <?=number_format($item['sale_retail'],2)?>
            </strong></td>
          <td class="<?="qty-$x";?>"><?=$item['quantity'];?></td>
          <td class="<?="total-item-$x";?>"><strong style="color:#009900;">$
            <?=number_format($item['sale_retail'] * $item['quantity'] ,2)?>
            </strong></td>
