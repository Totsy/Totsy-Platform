<style type="text/css">
	ul.bullets { list-style-type:disc; font-size:8px; margin:0px -20px 2px -25px; }
	.photo_avatar { float:left; display:block; width:100px; margin:0px; }
	.mtm_right_content { margin:0px 0px 0px 10px; font-size: 11px; display:block; float:left; width:179px; }
	.mtm_page_break { margin:45px 0px!important; clear:both; }
	em {display: block; padding:5px; font-weight: bold; font-style: italic;}
	.bigger {font-size:14px; margin:0px 0px 10px 0px;}
...
<?php $this->title("Meet the Moms"); ?>
    ...
    <div class="photo_avatar"><img src="/img/diana_mom.jpg" title="" width="100" alt="" /> <br />
      <ul class="bullets">
        <li>Lives in New York, NY</li>
        <li>Grew Up in Biloxi, MS</li>
        <li>Mom of 2 girls <br />
          (20 mos) and (5 mos)</li>
      </ul>
      <br />
      <h5 class="gray"><strong>Follow This Mom</strong></h5>
      <hr />
      <span class="fl" style="margin-right:5px;"><a href="http://www.twitter.com/totsymom" target="_blank"><img src="/img/icons/twitter_16.png" alt="" /></a></span> <span class="fl"><a href="http://www.facebook.com/TotsyMom" target="_blank"><img src="/img/icons/facebook_16.png" alt="" /></a></span>
    ...
    <div class="mtm_right_content">
      ...
      <p>Diana Dornan Heather is Totsy's resident Chief Mom. In corporate speak that's 
        ...
        and voice of Totsy.</p>
      <p>That's a big job, but she's earned it! She's been working in the online and 
        social media worlds in NYC as Senior Editor of Celebrations.com (owned by 
        1-800-Flowers.com) giving advice with national experts like Preston Bailey on making all 
        of life's occasions more special; managing PR and social media projects for major 
        brands like Mikasa, Henri Bendel and Harry Winston and as Editor-in-Chief of 
        StarStyle, which was a groundbreaking "supersite" that enabled viewers to identify 
        and purchase the apparel, furnishings and music featured in their favorite TV 
      ...
      <p>Her favorite topic of late is how a newborn and a toddler may or may not be able 
        to share a room together! (that's still TBD)</p>
      <p>Diana has appeared on Access Hollywood, Inside Edition, CBS News and WPIX 11 to 
        discuss trends in fashion, style and party planning. She recently shot an 
        episode for a new series on BRAVO called "Pregnant in Heels" which will air in the 
        spring of 2011. </p>
      <h5 class="gray"><strong>You've Seen Diana On:</strong></h5>
      <hr />
      <ul class="bullets">
        <li>Access Hollywood</li>
        <li>Inside Edition</li>
        <li>MTV Canada</li>
        <li>Extra!</li>
        <li>Sirius XM Radio with Candace Bushnell</li>
        <li>BRAVO's Pregnant in Heels (coming soon) </li>
      </ul>
    ...
    <!-- start mom block -->
    <div style="clear:both;"><hr /></div>
    <div class="photo_avatar"><img src="/img/BaileyFamily.jpg" title="" width="100" alt="" /> <br />
      <ul class="bullets">
      ...
      <h5 class="gray"><strong>Follow This Mom</strong></h5>
      <hr />
      <span class="fl" style="margin-right:5px;"><a href="http://twitter.com/rockinmama" target="_blank"><img src="/img/icons/twitter_16.png" alt="" /></a></span> <span class="fl"><a href="http://www.facebook.com/pages/Rockin-Mama/296829598089" target="_blank"><img src="/img/icons/facebook_16.png" alt="" /></a></span>
      <div style="clear:both;"></div>
    </div>
    <div class="mtm_right_content">
      ...
      <p><strong><em>"Rockin' Mama was named Top 50 Mom Blogs by Access PR."</em></strong></p>
      ...
      <hr />
      <ul class="bullets">
        <li>Top 50 Mommy Blogs by Access PR</li>
        <li>Top Mom & Dad Blogs by Online Schools</li>
        <li>CBS Los Angeles freelance writer</li>
      </ul>
      <div class="mtm_page_break"></div>
    </div>
    <!-- end mom block --> 
    ...
    <!-- start mom block -->
    <div style="clear:both;"><hr /></div>
    <div class="photo_avatar"><img src="/img/SaraFisher_011.jpg" title="" width="100" alt="" /> <br />
      <ul class="bullets">
        <li><a href="http://www.selfmademom.net/">SelfMadeMom</a></li>
        <li><a href="http://2momsmedia.com">2 Moms Media</a></li>
        <li>Chicago, IL</li>
        <li>Mom to 2 boys (4 yrs) and (1 yr)</li>
      </ul>
      <br />
      <h5 class="gray"><strong>Follow This Mom</strong></h5>
      <hr />
      <span class="fl" style="margin-right:5px;"><a href="http://twitter.com/selfmademom" target="_blank"><img src="/img/icons/twitter_16.png" alt="" /></a></span> <span class="fl"><a href="http://www.facebook.com/people/Sara-Rontal-Fisher/793732924" target="_blank"><img src="/img/icons/facebook_16.png" alt="" /></a></span>
      <div style="clear:both;"></div>
    </div>
    <div class="mtm_right_content">
      ...
      <ul class="bullets">
        ...
        <li>Chicago Parent- regular features contributor</li>
        <li>Syndicated NBC affiliate websites</li>
        <li>Former employee of Edelman (Ad Age's Top-Ranked PR Firm of the Decade)</li>
      </ul>
      <div class="mtm_page_break"></div>
    </div>
    <!-- end mom block --> 
    ...
    <!-- start mom block -->
    <div style="clear:both;"><hr /></div>
    <div class="photo_avatar"><img src="/img/Jodi_Grundig_Photo.jpg" title="" width="100" alt="" /> <br />
      <ul class="bullets">
        <li><a href="http://www.momsfavoritestuff.com">MomsFavBabyoriteStuff</a></li>
        <li>Boston, MA</li>
        <li>Mom to a boy (4 yrs) and a girl (6 yrs)</li>
      </ul>
      <br />
      <h5 class="gray"><strong>Follow This Mom</strong></h5>
      <hr />
      <span class="fl" style="margin-right:5px;"><a href="http://twitter.com/JodiGrundig" target="_blank"><img src="/img/icons/twitter_16.png" alt="" /></a></span> <span class="fl"><a href="http://www.facebook.com/jodigrundig" target="_blank"><img src="/img/icons/facebook_16.png" alt="" /></a></span>
      <div style="clear:both;"></div>
    </div>
    <div class="mtm_right_content">
      ...
      <hr />
      <ul class="bullets">
        <li>Superfood Ambassador for Genesis Today</li>
        <li>Spokesmom &amp; Ambassador for ConAgra Foods</li>
        <li>Walt Disney World Moms Panel</li>
        <li>Yahoo! Mother Board Member</li>
        <li>Fox 25 and New England Cable News Appearances</li>
        <li>Honda Odyssey commercial appearance</li>
      </ul>
      <div class="mtm_page_break"></div>
    </div>
    <!-- end mom block --> 
    ...
    <!-- start mom block -->
    <div style="clear:both;"><hr /></div>
    <div class="photo_avatar"><img src="/img/MarybethHamilton.jpg" title="" width="100" alt="" /> <br />
      <ul class="bullets">
        <li><a href="http://babygoodbuys.com">Baby Goodbuys</a></li>
        <li>Boston, MA</li>
        <li>Mom to a boy (4 yrs) and a girl (6 yrs)</li>
      </ul>
      <br />
      <h5 class="gray"><strong>Follow This Mom</strong></h5>
      <hr />
      <span class="fl" style="margin-right:5px;"><a href="http://twitter.com/BabyGoodBuys" target="_blank"><img src="/img/icons/twitter_16.png" alt="" /></a></span> <span class="fl"><a href="http://www.facebook.com/BabyGoodBuys" target="_blank"><img src="/img/icons/facebook_16.png" alt="" /></a></span>
      <div style="clear:both;"></div>
    </div>
    <div class="mtm_right_content">
    ...
    <!-- start mom block -->
    <div style="clear:both;"><hr /></div>
    <div class="photo_avatar"><img src="/img/april-hussar2.jpg" title="" width="100" alt="" /> <br />
      <ul class="bullets">
        <li><a href="http://www.bettyconfidential.com/">BettyConfidential</a></li>
        <li>New York, NY</li>
        <li>Mom to a girl (7 yrs)</li>
      </ul>
      <br />
      <h5 class="gray"><strong>Follow This Mom</strong></h5>
      <hr />
      <span class="fl" style="margin-right:5px;"><a href="http://twitter.com/aprilhussar" target="_blank"><img src="/img/icons/twitter_16.png" alt="" /></a></span> <span class="fl"><a href="http://www.facebook.com/bettyconfidential" target="_blank"><img src="/img/icons/facebook_16.png" alt="" /></a></span>
      <div style="clear:both;"></div>
    </div>
    <div class="mtm_right_content">
      ...
      <hr />
      <ul class="bullets">
        <li>Forbes.com's "Top 100 Websites for Women"</li>
        <li>min 2010 Editorial Excellence Award Winner</li>
    ...
    <!-- start mom block -->
    <div style="clear:both;"><hr /></div>
    <div class="photo_avatar"><img src="/img/Piera.jpg" title="" width="100" alt="" /> <br />
      <ul class="bullets">
        <li><a href="http://www.jollymom.com">JollyMom</a></li>
        <li>Atlanta, GA</li>
        <li>Mom to a boy (3 yrs)</li>
      </ul>
      <br />
      <h5 class="gray"><strong>Follow This Mom</strong></h5>
      <hr />
      <span class="fl" style="margin-right:5px;"><a href="http://twitter.com/jollymom" target="_blank"><img src="/img/icons/twitter_16.png" alt="" /></a></span> <span class="fl"><a href="http://www.facebook.com/TheJollyMom" target="_blank"><img src="/img/icons/facebook_16.png" alt="" /></a></span>
      <div style="clear:both;"></div>
    </div>
    <div class="mtm_right_content">
      ...
      <hr />
      <ul class="bullets">
        <li>Power Mom by Nielsen in 2009</li>
        <li>50 Top Mom Blogs by Access Communications in 2010</li>
        <li>Big Hit Avocado Recipe Contest 2010 3d Place Winner</li>
      </ul>
      <div class="mtm_page_break"></div>
    </div>
    <!-- end mom block --> 
    ...
    <!-- start mom block -->
    <div style="clear:both;"><hr /></div>
    <div class="photo_avatar"><img src="/img/Angela_Roy.jpg" title="" width="100" alt="" /> <br />
      <ul class="bullets">
        <li><a href="http://www.mommypr.com">MommyPR</a></li>
        <li>Seattle, WA</li>
        <li>Mom to 2 girls (7 yrs) and (3 yrs)</li>
      </ul>
      <br />
      <h5 class="gray"><strong>Follow This Mom</strong></h5>
      <hr />
      <span class="fl" style="margin-right:5px;"><a href="http://twitter.com/MommyPR" target="_blank"><img src="/img/icons/twitter_16.png" alt="" /></a></span> <span class="fl"><a href="http://www.facebook.com/profile.php?id=1832814102" target="_blank"><img src="/img/icons/facebook_16.png" alt="" /></a></span>
      <div style="clear:both;"></div>
    </div>
    <div class="mtm_right_content">
...
<p><strong><em>"From press releases to product reviews, from giveaways to marketing campaigns, the content on MommPR.com certainly qualifies Angela a PR genius."</em></strong></p>
  ...
  <li>Public Relations Director for Dreamcatchers for Abused Children</li>
  <li>CleanItSupply.com</li>
      </ul>
      <div class="mtm_page_break"></div>
    </div>
    <!-- end mom block --> 
        ...
        <!-- start mom block -->
        <div style="clear:both;"><hr /></div>
    <div class="photo_avatar"><img src="/img/courtheadshot4.jpg" title="" width="100" alt="" /> <br />
      <ul class="bullets">
     <li><a href="http://www.mydallasmommy.com">MyDallasMommy</a></li>
  <li>Dallas, TX</li>
  <li>Mom to 3 girls (6 yrs) (4 yrs) and (2 yrs) - our hero!</li>
      </ul>
      <br />
      <h5 class="gray"><strong>Follow This Mom</strong></h5>
      <hr />
      <span class="fl" style="margin-right:5px;"><a href="http://twitter.com/mydfwmommy" target="_blank"><img src="/img/icons/twitter_16.png" alt="" /></a></span> <span class="fl"><a href="http://www.facebook.com/DFWMommy" target="_blank"><img src="/img/icons/facebook_16.png" alt="" /></a></span>
      <div style="clear:both;"></div>
    </div>
    <div class="mtm_right_content">
...
<p>Before having her children, Courtney worked as a school social worker, using her B.S. in Psychology. She has a true passion and beliefs in helping others better their circumstances, Courtney is also a phenomenal Twitter Party host!</p>
  ...
  <li>CBS</li>
  <li>All You Magazine</li>
  <li>Pampers Mom's Panel </li>
  <li>Collective Bias Advisory Panel</li>
      </ul>
      <div class="mtm_page_break"></div>
    </div>
    <!-- end mom block --> 
            ...
            <!-- start mom block -->
            <div style="clear:both;"><hr /></div>
    <div class="photo_avatar"><img src="/img/VeraSweeney.gif" title="" width="100" alt="" /> <br />
      <ul class="bullets">
     <li><a href="http://imnotobsessed.com/">I'm Not Obsessed</a></li>
     <li><a href="http://www.ladyandtheblog.com/">Lady and the Blog</a></li>
  <li>New York, NY </li>
  <li>Mom to 2 a girl (4) and a boy (2)</li>
      </ul>
      <br />
      <h5 class="gray"><strong>Follow This Mom</strong></h5>
      <hr />
      <span class="fl" style="margin-right:5px;"><a href="http://twitter.com/imnotobsessed" target="_blank"><img src="/img/icons/twitter_16.png" alt="" /></a></span> <span class="fl"><a href="http://www.facebook.com/verasweeney" target="_blank"><img src="/img/icons/facebook_16.png" alt="" /></a></span>
      <div style="clear:both;"></div>
    </div>
    <div class="mtm_right_content">
...
<p>Her family business receives an average of 5 million page views a month! Vera lives in NYC with her hubby and two kids. </p>
  ...
  <li>NY Newsday</li>
  <li>NY Daily News </li>
  <li>Pregnancy and Newborn Magazine</li>
      </ul>
      <div class="mtm_page_break"></div>
    </div>
    <!-- end mom block --> 
