...
<?php 
$totalSecondWeekRevenue = $FirstWeekRevenue + $secondWeekRevenue;
$totalThirdWeekRevenue = $FirstWeekRevenue + $secondWeekRevenue + $thirdWeekRevenue;

$totalSecondWeekNewUsers = $FirstWeekNewUsers + $secondWeekNewUsers;
$totalThirdWeekNewUsers = $FirstWeekNewUsers + $secondWeekNewUsers + $thirdWeekNewUsers;


$totalLastMonthSecondWeekRevenue = $lastMonthFirstWeekRevenue + $lastMonthSecondWeekRevenue;
$totalLastMonthThirdWeekRevenue = $lastMonthFirstWeekRevenue + $lastMonthSecondWeekRevenue + $lastMonthThirdWeekRevenue;

$totalLastMonthSecondWeekNewUsers = $lastMonthFirstWeekNewUsers + $lastMonthSecondWeekNewUsers;
...
<br><br><br><br>
  <table class="datatable">
   ...
   <tr>
    ...
    <td>
    <?php
    $percentage = ($FirstWeekRevenue / $lastMonthFirstWeekRevenue);
    if($percentage < 1){
    ...
    <td>
    <?php
    $percentage = ($currentMonthRevenue / $lastMonthRevenue);
    if($percentage < 1){
   ...
   <?php echo date('M jS',$startOfTheLast6Month) . " - " . date('M jS',$startOfTheLast3Month) ?>
    ...
    <td>
     <?php
    $percentage = ($last3MonthRevenue / $last6MonthRevenue);
    if($percentage < 1){
...
<br><br><br><br>
  ...
  <table class="datatable">
    ...
    <td>
    <?php
    $percentage = ($todayNewUsers / $yesterdayNewUsers);
    if($percentage < 1){
    ...
    <tr>
    <td><?= number_format( $lastMonthFirstWeekNewUsers , $decimals = 0 , $dec_point = '.' , $thousands_sep = ',' ) ?></td>
    <td><?= number_format( $FirstWeekNewUsers , $decimals = 0 , $dec_point = '.' , $thousands_sep = ',' ) ?></td>
    <td>
    <?php
    $percentage = ($FirstWeekNewUsers / $lastMonthFirstWeekNewUsers);
    if($percentage < 1){
    ...
    <tr>
    <td><?= number_format( $totalLastMonthSecondWeekNewUsers , $decimals = 0 , $dec_point = '.' , $thousands_sep = ',' ) ?></td>
    <td><?= number_format( $totalSecondWeekNewUsers , $decimals = 0 , $dec_point = '.' , $thousands_sep = ',' ) ?></td>
    <td>
    <?php
    $percentage = ($totalSecondWeekNewUsers / $totalLastMonthSecondWeekNewUsers);
    if($percentage < 1){
    ...
    <tr>
    <td><?= number_format( $totalLastMonthThirdWeekNewUsers , $decimals = 0 , $dec_point = '.' , $thousands_sep = ',' ) ?></td>
    <td><?= number_format( $totalThirdWeekNewUsers , $decimals = 0 , $dec_point = '.' , $thousands_sep = ',' ) ?></td>
    <td>
    <?php
    $percentage = ($totalThirdWeekNewUsers / $totalLastMonthThirdWeekNewUsers);
    if($percentage < 1){
    ...
    <tr>
    <td><?= number_format( $lastMonthNewUsers , $decimals = 0 , $dec_point = '.' , $thousands_sep = ',' ) ?></td>
    <td><?= number_format( $currentMonthNewUsers , $decimals = 0 , $dec_point = '.' , $thousands_sep = ',' ) ?></td>
    <td>
    <?php
    $percentage = ($currentMonthNewUsers / $lastMonthNewUsers);
    if($percentage < 1){
   ...
   <?php echo date('M jS',$startOfTheLast6Month) . " - " . date('M jS',$startOfTheLast3Month) ?>
    ...
    <tr>
    <td><?= number_format( $last6MonthNewUsers , $decimals = 0 , $dec_point = '.' , $thousands_sep = ',' ) ?></td>
    <td><?= number_format( $last3MonthNewUsers , $decimals = 0 , $dec_point = '.' , $thousands_sep = ',' ) ?></td>
    <td>
     <?php
    $percentage = ($last3MonthNewUsers / $last6MonthNewUsers);
    if($percentage < 1){
