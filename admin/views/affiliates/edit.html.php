...
<div class="grid_6 box">
	...
	<div class="block forms">
		<?=$this->form->create(null, array('id' => 'mainForm', 'enctype'=>'multipart/form-data'));?>
			...
			?>
			Affiliate Level: <select name="level" id="Level"> <?=$option; ?> </select> <br><br>
		Affiliate Name:
			...
			<div id ="tabs">
				...
				<div id="pixel">
					...
					<div id="pixel_panel"><!--start pixel panel-->
						...
						?>
						<input type="hidden" id="pixel_count" name="pixel_count" value="<?=$count; ?>" />
						<br>
					</div> <!--end pixel panel-->
				</div><!--end pixel-->
