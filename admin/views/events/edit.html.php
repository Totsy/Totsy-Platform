		...
		<div id="event_info">
			...
			<h4 id="article-heading">Event Description</h4>
				...
				<div id="event_voucher">
					...
					<input type="radio" name="voucher" value="1" id="voucher" <?php if ($event->voucher == 1) echo 'checked'; ?>> Yes <br>
					<input type="radio" name="voucher" value="0" id="voucher" <?php if ($event->voucher == 0) echo 'checked'; ?>> No
				</div>
