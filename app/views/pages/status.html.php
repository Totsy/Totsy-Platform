...
<div id="page">
	...
	<h2 class="gray mar-b">Site Status</h2>

	<p>Check here to learn about updates and pending support efforts on the new website.</p>
	...
	<p>Like credits, order data is in the process of being massaged and imported to the new platform. This is expected to be up shortly.
