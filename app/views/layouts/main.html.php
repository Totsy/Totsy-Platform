...
<head>
	...
	<?php echo $this->html->style(array('base.css?v='.sha1(date()).'', '960.css?v='.sha1(date()).'', 'jquery_ui_custom/jquery.ui.all.css?v='.sha1(date()).''), array('media' => 'screen')); ?>
	...
	<?php echo $this->html->script('jquery.uniform.min.js?v='.sha1(date()).''); ?>
	<?php echo $this->html->script('jquery.countdown.min.js?v='.sha1(date()).''); ?>
