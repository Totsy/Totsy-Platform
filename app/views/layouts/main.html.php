...
if( ($controllerName=="checkout" && $URIArray[2]!=="view") || ($controllerName=="orders" && $URIArray[2]!=="view") || ($controllerName=="cart" && $URIArray[2]==!"view" ) || $isWhiteLabel==true || $controllerName=="pages") { 
?>
<script type="text/javascript">
