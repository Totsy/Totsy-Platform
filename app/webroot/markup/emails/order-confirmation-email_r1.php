						...
						<table cellpadding="0" cellspacing="0" width="100%" style="border-left:1px solid #666666; border-right:1px solid #666">
							<tr>
								<td colspan="4" style="padding:0 10px 10px 10px">
									...
									?>
									<!--  img src="../../img/email/order-confirmation.jpg" alt="order-confirmation" width="570" height="77" / -->
								</td>
							</tr>
							<tr>
								<td style="padding:20px" valign="top">
									<p style="font-weight:bold">Order ID: 3413292</p>
									<p>Dear [Customer Name],</p> 
									<p>Thank you so much for shopping with Totsy. Please find your order summary information below.
									<br>
									A detailed summary of your order is also available at <a href="#" title="Totsy.com" style="color:#E00000;text-decoration:none">www.totsy.com</a>.</p>
								</td>
							</tr>
							<tr>
								<td style="color:#666666;padding-top:5px;padding-bottom:5px;padding-left:20px" valign="top">
								ESTIMATED DELIVERY: Thu 3/11/10 to Mon 3/15/10		
							</tr>
							<tr>
								<td style="color:#666666;padding:0 20px;" colspan="4"><!-- start order detail table -->
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										...
										<!-- *********************** this is where the loop for the product list starts *************** -->
											...
											<!-- ************** this is where the loop for the product list ends *******************-->					
										...
										<!-- tr style="background-color:#e8e8e8;text-align:center">
											...
											<td height="100" style="border-right:1px solid #666666;padding-top:5px;padding-bottom:5px;text-align:left;padding-left:5px" title="description">
												<strong style="font-weight:bold;color:#666666">Stroller A</strong>
												<br>
												<strong style="font-weight:normal">Wheel Stripe</strong>
												<br>
												<strong style="font-weight:bold">Color:</strong> <strong style="font-size:10pt;font-weight:normal">red</strong>
												<br>
												<strong style="font-weight:bold">Size:</strong> <strong style="font-size:10pt;font-weight:normal">NA</strong>
											</td>
										...
										<tr>
											<td style="padding:0 0 0 20px;color:#888888">
												<p>A TREE HAS BEEN PLANTED WITH THIS ORDER.
													<br>
													<strong style="color:#E00000;font-weight:normal">Find out how every purchase makes a difference.</strong>
												</p>
											</td>
											<td>
