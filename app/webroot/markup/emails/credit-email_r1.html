...
<body>
	...
	<center>
		<table cellspacing="0" cellpadding="0" border="0" width="592">	
				...
				<tr>
					<td colspan="4" style="text-align:center;padding:10px;font-size:11px">
						...
						<table cellpadding="0" cellspacing="0" width="100%" style="border-left:1px solid #666; border-right:1px solid #666">
							...
							<tr>
								<td colspan="4" style="padding:0 10px 10px 10px">
									<img src="../../img/email/main_image.jpg" alt="main_image" width="570" height="177" />
								</td>
							</tr>
							<tr>
								<td style="padding:20px" valign="top">
									<p>What a coup - <strong style="color:#E00000">$15</strong> just added!</p>
									<p>[insert shopper names] just shopped at Totsy for the first time. So we've added $15 to your Totsy Credit.</p>
									<p>Have a look at Today's Sales and the premier brands on the calendar. Choose the most dream-worthy among them. And remember that you'll earn an additional $15 every time any new member you invite makes an initial purchase.</p>
									<p>Thank you for inviting your friend. We believe that sharing -- and stellar designer finds -- make life a little more enjoyable.</p>
									<p>All the best,</p>
				...
				<tr>
					<td colspan="4" style="text-align:center;padding:20px;font-size:11px">
