...
<div id="page"> 
	...
	Totsy is a private shopping network of exclusive, brand-specific sales, up to 70% off retail, for moms on-the-go, moms-to-be, and kids, ages 0-7. Prenatal care products, baby gear, travel accessories, bedding and bath, children's clothing, toys, DVDs, and educational materials are just a sampling of a selection that promises only the best in quality and designer brands. Each sale lasts 48 to 72 hours.</p>

	<p><strong>How do I become a member of Totsy?</strong><br />
	Membership is free. You can join either by accepting an invitation offer from a friend or by requesting your membership via Totsy's sign-in page.</p>
	...
	Generally no, especially on final sales, but you always have the option to call customer service to explain the situation.</p>
	...
	For standard delivery, we ship via USPS Priority Mail. For express delivery, we ship via UPS.</p>
	...
	We do not yet have international delivery rates set up, but if there is a specific request, you can contact us either via email or phone.</p>
	...
	If you forget your password, you can reset it via the "Forgot Your Password?" link on Totsy's sign-in page. You'll be directed to a new page and asked to input your email address. We will then email you a link to reset your password and create a new one.</p>

	<p><strong>How do I change my password, my shipping and/or billing address, email address, and/or credit card information?</strong><br />
	...
	You can only store one address, but you will have the option to change the shipping address during checkout.</p>

	<p><strong>How do I unsubscribe to email notices?</strong><br />
	To unsubscribe from our email notices, just click on the unsubscribe link found at the bottom of every email. You'll be taken directly to a page that will ask you to confirm that you want to be removed from our database. Once you confirm, we'll automatically remove you from our lists.</p>
