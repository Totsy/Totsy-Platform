...
>>>>>>> 4b2354d10c802b820b3a6552c30f024afc567753
                ...
                <div style="padding-top:10px; float:right; width:425px;">
                    ...
                    <div style="font-weight:bold;" >
                        <div class="subtotal">
                            <span id="shipping_tooltip" style="float:left; margin-left:-16px;" original-title="Shipping charges may vary depending on item type.">
                    ...
                    <?php if (!empty($shipping_discount)):?>
                        ...
                        <div style="font-weight:bold" class="subtotal">
                            ...
                            <span style="color:#707070; float:right" class="fees_and_discounts">- $<?=number_format($shipping_discount,2)?>
                            </span>
                        </div>
                    <?php endif; ?>
                    <div style="clear:both"></div>
                    <div style="font-weight:bold">
                        <div class="subtotal">
                            <span id="tax_tooltip" style="float:left; margin-left:-16px;" original-title="Sales tax will be calculated once we collect the shipping address for this order. If you are shipping to NY or NJ, tax will be charged on the order subtotal, shipping and handling at the applicable county rate. Tax rates within counties vary">
                                <img src="/img/tooltip_icon.png"/>
                            </span>
                            <span id="estimated_tax" style="float:left;">Estimated Tax:</span>
                            <span style="float:right" class="fees_and_discounts">$0.00</span>
                ...
                <?=$this->form->end(); ?>
                    ...
                    <div>
                        ...
                        <div class="subtotal">
                            ...
                            <span style="font-size:15px; color:#009900; float:right" id="ordertotal">
...
=======
   <div id="remove_form" style="display:none">
        ...
        <div class="clear"></div>
    <?php else: ?>
        <div class="grid_16" style="padding:20px 0; margin:20px 0;">
            <h1>
                <center>
                    <span class="page-title gray" style="padding:0px 0px 10px 0px;">Your shopping cart is empty
                    </span>
                    <a href="/sales" title="Continue Shopping">Continue Shopping</a/>
                </center>
            </h1>
        </div>
    <?php endif ?>
